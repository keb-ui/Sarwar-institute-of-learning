    ...
    >
      ...
      >
        ...
        >
          <motion.a
            href="#pricing"
            className="px-8 py-4 bg-primary text-primary-foreground rounded-xl font-medium text-lg hover:bg-primary/90 transition-colors shadow-lg inline-block cursor-pointer"
          ...
          <motion.a
            href="#subjects"
            className="px-8 py-4 bg-secondary text-secondary-foreground rounded-xl font-medium text-lg hover:bg-muted transition-colors border-2 border-border inline-block cursor-pointer"
            whileHover={{ scale: 1.05, y: -2 }}
            whileTap={{ scale: 0.95 }}
          >
            Explore Subjects
